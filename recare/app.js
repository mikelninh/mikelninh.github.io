(()=>{
  ...
  if(architecture){
    ...
    </div><div class="proof-footer"><p><strong>Boundary, intentionally explicit:</strong> this page is a static interactive work sample. The linked repositories contain deeper backend, retrieval, agent and test evidence. I have not yet operated GenAI at Recare-scale production healthcare traffic; that is the experience I want to earn next.</p><a href="https://github.com/mikelninh/care-os" target="_blank" rel="noreferrer">Inspect CareOS evidence ↗</a></div><div class="proof-footer"><p><strong>Supporting proofs:</strong> GitLaw → hybrid retrieval/citation verification · Digital Worker Factory → reusable agent runtime/evals · PrüfPilot → document AI + versioned evidence workflows.</p><a href="https://mikelninh.github.io/" target="_blank" rel="noreferrer">Open portfolio ↗</a></div></div>`;
